...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // extensions/co2-emission-container/src/index.tsx
  var import_react13 = __toESM(require_react());
  var import_jsx_runtime = __toESM(require_jsx_runtime());
  render2("Checkout::CartLines::RenderAfter", () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(App, {}));
  function App() {
    const lines = useCartLines();
    const [isLoading, setIsLoading] = (0, import_react13.useState)(true);
    const [showCO2, setShowCO2] = (0, import_react13.useState)(false);
    ...
    const [shopUrl, setShopUrl] = (0, import_react13.useState)();
    const [shopId, setShopId] = (0, import_react13.useState)();
    const [calculations, setCalculations] = (0, import_react13.useState)();
    const [co2EmissionsTotal, setCo2EmissionsTotal] = (0, import_react13.useState)(0);
    const [merchant, setMerchant] = (0, import_react13.useState)();
    const [recommerce, setRecommerce] = (0, import_react13.useState)(false);
    const [planType, setPlanType] = (0, import_react13.useState)("");
    ...
    (0, import_react13.useEffect)(() => __async(this, null, function* () {
      yield fetch(`https://fortheearth-api.cartediem.org/api/v1/merchant/config/${shopId}`).then((resp) => resp.json()).then((merchantInfo) => setMerchant(merchantInfo));
    }), [shopId]);
    (0, import_react13.useEffect)(() => {
      ...
      if (extension.shippingAddress) {
        setAddress({
          ...
          city: (_a = extension.shippingAddress.current.city) == null ? void 0 : _a.toLowerCase(),
    ...
    function getCalculations() {
      return __async(this, null, function* () {
        ...
        let calcEndpoint = "";
        if (((_b = (_a = merchant == null ? void 0 : merchant.plan) == null ? void 0 : _a.config) == null ? void 0 : _b.emissionType) === "ALL") {
          calcEndpoint = "carbon-production";
        }
        if (((_d = (_c = merchant == null ? void 0 : merchant.plan) == null ? void 0 : _c.config) == null ? void 0 : _d.emissionType) === "TRANSPORT") {
          calcEndpoint = "transport-emission";
        }
        if (((_f = (_e = merchant == null ? void 0 : merchant.plan) == null ? void 0 : _e.config) == null ? void 0 : _f.emissionType) === "BASKET") {
          calcEndpoint = "basket-emission";
        }
        if (calcEndpoint.length > 1) {
          extension.storage.write("lineItems", items);
          yield fetch(`https://logistics-service.cartediem.org/api/v1/carbon-accounting/calculate/${calcEndpoint}`, {
            "method": "POST",
            "headers": {
    ...
    (0, import_react13.useEffect)(() => __async(this, null, function* () {
      if (address.address1) {
        yield getCalculations();
      }
    }), [address]);
    (0, import_react13.useEffect)(() => {
      var _a, _b;
      if (calculations && (merchant == null ? void 0 : merchant.plan)) {
        if (merchant.plan.config.emissionType === "ALL") {
          if ((calculations == null ? void 0 : calculations.basketEmission.total) < 0) {
            setRecommerce(true);
          }
          setCo2EmissionsTotal(calculations.basketEmission.total + ((_a = calculations == null ? void 0 : calculations.transportEmission) == null ? void 0 : _a.totalCo2Production));
        }
        ...
        if (merchant.plan.config.emissionType === "TRANSPORT") {
          setCo2EmissionsTotal((_b = calculations == null ? void 0 : calculations.transportEmission) == null ? void 0 : _b.totalCo2Production);
        }
      }
    }, [calculations]);
    if (calculations) {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(View2, {
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image2, {
                source: "https://i.imgur.com/Nc8kyQl.png"
              })
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(View2, {
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BlockStack2, {
                children: [
                  recommerce ? `With this purchase you give pre-owned items a second life. You help avoiding up to ${Math.abs(co2EmissionsTotal.toFixed(2))} kg CO2 emissions` : `This order causes up to ${co2EmissionsTotal.toFixed(2)} kg CO2eq (product + transport) Together with For the Earth we estimate emissions of every transaction`,
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Grid2, {
                    columns: ["fill", "auto"],
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heading2, {
                        level: 3,
                        children: recommerce ? `CO2 emissions avoided` : `CO2 emissions`
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heading2, {
                        inlineAlignment: "center",
                        level: 3,
                        children: `${Math.abs(co2EmissionsTotal.toFixed(2))} kg`
                      })
                    ]
                  })
                ]
