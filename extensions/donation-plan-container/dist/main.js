...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // extensions/donation-plan-container/src/index.tsx
  ...
  // node_modules/@shopify/checkout-ui-extensions/build/esm/components/BlockLayout/BlockLayout.mjs
  ...
  // node_modules/@shopify/checkout-ui-extensions/build/esm/components/Grid/Grid.mjs
  ...
  // node_modules/@shopify/checkout-ui-extensions/build/esm/components/TextBlock/TextBlock.mjs
  var TextBlock = createRemoteComponent("TextBlock");

  // node_modules/@shopify/checkout-ui-extensions/build/esm/components/View/View.mjs
  ...
  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/components/BlockLayout/BlockLayout.mjs
  ...
  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/components/Grid/Grid.mjs
  ...
  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/components/TextBlock/TextBlock.mjs
  var TextBlock2 = createRemoteReactComponent(TextBlock);

  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/components/View/View.mjs
  ...
  var ExtensionApiContext = /* @__PURE__ */ (0, import_react11.createContext)(null);

  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/hooks/api.mjs
  function useExtensionApi() {
    var api = (0, import_react12.useContext)(ExtensionApiContext);
    if (api == null) {
  ...
  function useSubscription(subscription) {
    var _useState = (0, import_react13.useState)(subscription.current), _useState2 = _slicedToArray(_useState, 2), setValue = _useState2[1];
  ...
  // node_modules/@shopify/checkout-ui-extensions-react/build/esm/hooks/shop.mjs
  function useShop() {
    return useExtensionApi().shop;
  }
  ...
  function useTranslate() {
    ...
    var translate = (0, import_react14.useCallback)(function() {
  ...
  function App() {
    const [displayMore, setDisplayMore] = (0, import_react16.useState)(false);
    const extension = useExtensionApi();
    const translate = useTranslate();
    const [merchantInfo, setMerchantInfo] = (0, import_react16.useState)(null);
    const [showError, setShowError] = (0, import_react16.useState)(false);
    const applyCartLinesChange = useApplyCartLinesChange();
    const lines = useCartLines();
    const shop = useShop();
    const [productIsOnCart, setProductIsOnCart] = (0, import_react16.useState)(false);
    const [actionButtons, setActionButtons] = (0, import_react16.useState)({});
    function loadData() {
      return __async(this, null, function* () {
        let shopId = shop.id.substring(shop.id.lastIndexOf("/") + 1);
        try {
          yield fetch(`https://fortheearth-api.cartediem.org/api/v1/merchant/config/${shopId}`).then((response) => response.json()).then((data) => {
            console.log({ data });
    ...
    (0, import_react16.useEffect)(() => {
      let newActionButtons = merchantInfo == null ? void 0 : merchantInfo.plan.layout.actionsLayout.actions.reduce((a, v) => __spreadProps(__spreadValues({}, a), { [v.name]: v }), {});
      setActionButtons(newActionButtons);
    }, [merchantInfo == null ? void 0 : merchantInfo.plan]);
    function handleAddItemOnCart(plan) {
      return __async(this, null, function* () {
        var _a;
        const result = yield applyCartLinesChange({
          type: "addCartLine",
          merchandiseId: (_a = plan.products[0]) == null ? void 0 : _a.variant.id,
          quantity: 1
        });
    ...
    if (merchantInfo == null ? void 0 : merchantInfo.plan) {
      let plan = merchantInfo == null ? void 0 : merchantInfo.plan;
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BlockLayout2, {
        spacing: "loose",
        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(View2, {
          border: "base",
          padding: "base",
          borderRadius: "base",
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BlockLayout2, {
            rows: ["auto", "auto"],
            spacing: "none",
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Grid2, {
                columns: [50, "fill", "auto"],
                spacing: "loose",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image2, {
                    fit: "cover",
                    source: plan.layout.titleLayout.url
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(BlockLayout2, {
                    rows: 20,
                    spacing: "none",
                    children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text2, {
                      size: "base",
                      children: plan.layout.titleLayout.title
                    })
                  }),
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BlockLayout2, {
                    rows: ["2", "auto"],
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(View2, {
                        ...
                        children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button2, {
                          ...
                          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image2, {
                            fit: "contain",
                            source: actionButtons ? actionButtons["PRICE"].url : null
                          })
                        })
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Grid2, {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button2, {
                            ...
                            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image2, {
                              fit: "contain",
                              source: actionButtons ? actionButtons["LEARN_MORE"].url : null
                            })
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button2, {
                            kind: "plain",
                            ...
                            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image2, {
                              fit: "contain",
                              source: actionButtons ? actionButtons["INFO"].url : null
                            })
                          })
                        ]
                      })
              ...
              displayMore && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Grid2, {
                columns: ["55%", "45%"],
                spacing: "tight",
                children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BlockLayout2, {
                    ...
                    children: [
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextBlock2, {
                        size: "small",
                        emphasis: "stress",
                        children: plan.layout.projectsLayout.title
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Grid2, {
                        columns: ["50%", "50%"],
                        inlineAlignment: "center",
                        spacing: "tight",
                        children: plan.layout.projectsLayout.projects.map((project, index) => {
                          return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(View2, {
                            maxBlockSize: 150,
                            maxInlineSize: 150,
                            children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image2, {
                              fit: "cover",
                      ...
                      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BlockLayout2, {
                        ...
                        children: [
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextBlock2, {
                            emphasis: "stress",
                            size: "small",
                            children: plan.layout.metricsLayout.title
                          }),
                          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextBlock2, {
                            size: "small",
                            children: plan.layout.metricsLayout.description
                          })
                        ]
                      }),
                      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Grid2, {
                        columns: ["50%", "50%"],
                        spacing: "tight",
                        children: plan.layout.metricsLayout.metrics.map((metric) => {
                          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Grid2, {
                            columns: [30, "fill"],
                            spacing: "tight",
                            children: [
                              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image2, {
                              ...
                              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BlockLayout2, {
                                ...
                                children: [
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text2, {
                                    size: "extraSmall",
                                    children: metric.name.split("").map((letter) => letter = letter === "_" ? " " : letter)
                                  }),
                                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text2, {
                                    size: "extraSmall",
