      ...
      if (true) {
        module.exports = function $$$reconciler($$$hostConfig) {
          ...
          function mountLayoutEffect(create, deps) {
            return mountEffectImpl(Update, Layout3, create, deps);
          }
          ...
          function mountImperativeHandle(ref, create, deps) {
            ...
            return mountEffectImpl(Update, Layout3, imperativeHandleEffect.bind(null, create, ref), effectDeps);
          }
...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // extensions/post-purchase-container/src/index.tsx
  ...
  // node_modules/@shopify/post-purchase-ui-extensions/build/esm/components/Separator/Separator.mjs
  var Separator = createRemoteComponent("Separator");
  ...
  // node_modules/@shopify/post-purchase-ui-extensions-react/build/esm/components/Image/Image.mjs
  ...
  // node_modules/@shopify/post-purchase-ui-extensions-react/build/esm/components/Separator/Separator.mjs
  var Separator2 = createRemoteReactComponent(Separator);

  // node_modules/@shopify/post-purchase-ui-extensions-react/build/esm/components/Text/Text.mjs
  ...
  // node_modules/@shopify/post-purchase-ui-extensions-react/build/esm/components/View/View.mjs
  var View2 = createRemoteReactComponent(View);

  // node_modules/@shopify/post-purchase-ui-extensions-react/build/esm/hooks/input.mjs
  ...
  function useExtensionInput() {
    var input = (0, import_react14.useContext)(ExtensionInputContext);
    if (input == null) {
  ...
  function render2(extensionPoint, render3) {
    return extend(extensionPoint, function(root, input) {
      render(/* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ExtensionInputContext.Provider, {
        value: input,
        children: render3(input)
      }), root, function() {
        root.mount();
      });
      return {};
  ...
  extend("Checkout::PostPurchase::ShouldRender", (_0) => __async(void 0, [_0], function* ({ inputData, storage }) {
    console.log({ inputData });
    const merchantInfo = yield getRenderData(inputData.shop.id);
    if (merchantInfo.response.plan)
      storage.update(merchantInfo);
    return { render: true };
  }));
  function getRenderData(shopId) {
    return __async(this, null, function* () {
      const response = yield fetch(`https://fortheearth-api.cartediem.org/api/v1/merchant/config/${shopId}`).then((resp) => resp.json()).then((merchant) => {
  ...
  function sendCheckoutData(data, merchant) {
    return __async(this, null, function* () {
      const toBeSend = {
      ...
      yield fetch("https://fortheearth-api.cartediem.org/api/v1/conscious-order", {
        "method": "POST",
        "headers": {
  ...
  render2("Checkout::PostPurchase::Render", () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(App, {}));
  function App() {
    const { done, inputData, storage } = useExtensionInput();
    console.log(inputData, storage);
    (0, import_react16.useEffect)(() => __async(this, null, function* () {
      yield sendCheckoutData(inputData.initialPurchase, storage.initialData.response.merchantId);
    }), []);
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(BlockStack2, {
      ...
      alignment: "center",
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(View2, {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(View2, {
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TextBlock2, {
            size: "large",
            emphasized: true,
            children: [
              storage.initialData.respone.plan.planId === "CARBON-OFFSETTING-1" && "With this order you planted xx trees in endangered ecosystems.",
              storage.initialData.respone.plan.planId === "REFORESTATION-1" && "With this order you planted xx trees in endangered ecosystems.",
              storage.initialData.respone.plan.planId === "DONATION-1" && "With this order you planted xx trees in endangered ecosystems."
            ]
          })
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Layout2, {
          maxInlineSize: 800,
          children: [
            storage.initialData.respone.plan.planId === "CARBON-OFFSETTING-1" && "With this order you planted xx trees in endangered ecosystems." ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image2, {
              fit: "cover",
              source: "https://cdn.shopify.com/s/files/1/0677/4567/7593/files/43A1692.jpg?v=1669996252"
            }) : null,
            storage.initialData.respone.plan.planId === "REFORESTATION-1" && "With this order you planted xx trees in endangered ecosystems." ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image2, {
              fit: "cover",
              source: "https://cdn.shopify.com/s/files/1/0677/4567/7593/files/GC24609wm.jpg?v=1669995859"
            }) : null,
            storage.initialData.respone.plan.planId === "DONATION-1" && "With this order you planted xx trees in endangered ecosystems." ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Image2, {
              fit: "cover",
              source: "https://cdn.shopify.com/s/files/1/0677/4567/7593/files/GC24609wm.jpg?v=1669995859"
            }) : null
          ]
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(View2, {
          children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextBlock2, {
            size: "large",
            emphasized: true,
            children: "Your order is confirmed on your way to you. Thank you!"
          })
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(View2, {
          children: lineItems.map((item) => {
            subtotal += Number(item.totalPriceSet.shopMoney.amount);
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Layout2, {
              maxInlineSize: 400,
              media: ["sma;;"],
              sizes: [250, 100],
              spacing: "extraLoose",
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(TextContainer2, {
                  alignment: "leading",
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text2, {
                      children: item.product.title
                    }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)(View2, {
                      inlinePadding: "extraLoose"
                    })
                  ]
                }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextContainer2, {
                  alignment: "trailing",
                  children: +item.totalPriceSet.shopMoney.amount === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(View2, {
                    children: "Free"
                  }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(View2, {
                    children: item.totalPriceSet.shopMoney.amount + " " + item.totalPriceSet.shopMoney.currencyCode
                  })
                })
              ]
            }, item.product.id);
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Layout2, {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextContainer2, {
              alignment: "leading",
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Text2, {
                emphasized: true,
                children: "Subtotal"
              })
            }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextContainer2, {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextBlock2, {
                emphasized: true,
                children: subtotal.toFixed(2) + " " + inputData.initialPurchase.totalPriceSet.shopMoney.currencyCode
              })
            })
          ]
        }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Layout2, {
          ...
          children: [
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextContainer2, {
              ...
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(TextBlock2, {
                emphasized: true,
                children: inputData.initialPurchase.totalPriceSet.shopMoney.amount + " " + inputData.initialPurchase.totalPriceSet.shopMoney.currencyCode
              })
            })
          ]
        }),
